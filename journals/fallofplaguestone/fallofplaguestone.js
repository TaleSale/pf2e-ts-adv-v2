...
class fallofplaguestoneJournalSheet extends JournalSheet {
  ...
  async activateListeners(html) {
    ...
    if (navigationElement) {
      navigationElement.style.background = "url('/modules/pf2e-ts-adv-v2/journals/fallofplaguestone/back.webp') no-repeat center center";
    ...
    try {
      const response = await fetch('/modules/pf2e-ts-adv-v2/journals/fallofplaguestone/keywords.json');
